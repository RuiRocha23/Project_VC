...
#cv2.circle(image_warp, (150, 127), 5, (0, 0, 255), -1)
#cv2.circle(image_warp, (750, 127), 5, (0, 0, 255), -1)
#cv2.circle(image_warp, (80, 510), 5, (0, 0, 255), -1)
#cv2.circle(image_warp, (815, 510), 5, (0, 0, 255), -1)
